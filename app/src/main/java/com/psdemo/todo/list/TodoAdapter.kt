...
class TodoAdapter(private val onClickListener: OnClickListener) : RecyclerView.Adapter<TodoAdapter.TodoHolder>() {
    ...
    inner class TodoHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(todo: Todo, clickListener: OnClickListener) {
            ...
            completed.setOnClickListener {
                clickListener.onCheckboxChecked(todo.id)
            }
            ...
            card.setCardBackgroundColor(itemView.context.getColor(determineCardColor(todo.dueDate, todo.completed)))
        }
    }
