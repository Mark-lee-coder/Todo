...
class ListViewModelTest {
    ...
    fun test_allTodosEmpty() {
        ...
        whenever(repository.getAllTodos()).thenReturn(MutableLiveData(arrayListOf()))
    ...
    fun test_allTodosSingle() {
        val repository: TodoRepository = mock()
        whenever(repository.getAllTodos()).thenReturn(MutableLiveData(arrayListOf(Todo("5", "Todo 5", now - day, false, now))))
